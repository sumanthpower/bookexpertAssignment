...
import { toggleDashBoard } from "../utils/employeeSlice";

const Dashboard = () => {
  const navigate = useNavigate();
  const isMenuOpen = useSelector((store) => store.emp.isMenuOpen);
  const isDashBoardOpen = useSelector((store) => store.emp.isDashBoardOpen);
            ...
            <div className="drawer-side">
              ...
              <ul className="menu bg-base-200 min-h-full w-60 p-4">
                ...
                <li className="mb-4 mt-5">
                  <a
                    className="bg-slate-800 text-white rounded-3xl p-2 px-6  min-w-full"
                    onClick={printEmployes}
                  >
                    + Print Employee
                  </a>
                </li>
